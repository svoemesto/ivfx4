    ...
    fun createTracksFromMediaInfo(file: File) {
        ...
        if (listJsonTracks != null) {
            ...
            file.tracks.forEach{ track ->
                Main.propertyController.deleteAll(track::class.java.simpleName, track.id)
                Main.propertyCdfController.deleteAll(track::class.java.simpleName, track.id)
            }
            deleteAll(file)
                ...
                jsonTrack.entries.forEach { entry ->
                    ...
                    if (entry.value is LinkedTreeMap<*, *>) {
                        ...
                        jsonTrack2.entries.forEach { entry2 ->
                            ...
                            Main.propertyController.editOrCreate(track::class.java.simpleName,
