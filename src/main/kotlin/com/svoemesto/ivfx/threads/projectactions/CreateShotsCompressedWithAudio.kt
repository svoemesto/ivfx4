...
class CreateShotsCompressedWithAudio(var fileExt: FileExt,
    ...
    override fun run() {
        ...
        if (!File(fileExt.folderShotsCompressedWithAudio).exists()) File(fileExt.folderShotsCompressedWithAudio).mkdir()
