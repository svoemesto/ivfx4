...
class CreateShotsLosslessWithoutAudio(var fileExt: FileExt,
    ...
    override fun run() {
        ...
        this.name = "CreateShotsLosslessWithoutAudio"
        ...
        if (!File(fileExt.folderShotsLosslessWithoutAudio).exists()) File(fileExt.folderShotsLosslessWithoutAudio).mkdir()
        ...
        for ((i, shotExt) in fileExt.shotsExt.withIndex()) {
            ...
            val fileOutput = shotExt.pathToLosslessWithoutAudio
...
//            builderOutput.setVideoFilter(filter)
        ...
        fileExt.hasShotsLosslessWithoutAudio = true
        table.refresh()
